...
export async function exportLocalData() {
  ...
  const tables = db
    ? {
        ...
        classificationGroup: await db.classificationGroup.toArray(),
        classificationValue: await db.classificationValue.toArray(),
        speciesClassification: await db.speciesClassification.toArray(),
        speciesDisease: await db.speciesDisease.toArray(),
        careProfile: await db.careProfile.toArray(),
